...
export const CustomButton: React.FC<CustomButtonProps> = ({ type, size, text, onClick }) => {
  let imageSrc = "";
  if (type === "copper" && size === "small") imageSrc = "/src/assets/btn_small_copper.png";
  else if (type === "copper" && size === "long") imageSrc = "/src/assets/btn_long_copper.png";
  else if (type === "gm" && size === "small") imageSrc = "/src/assets/btn_small_gm.png";
  else if (type === "gm" && size === "long") imageSrc = "/src/assets/btn_long_gm.png";
